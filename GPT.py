...
class GPTLanguageModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.pos_embdedding=nn.Embedding(block_size,n_embd)
    ...
    def forward(self, idx, targets=None):
        ...
        pos_embd = self.pos_embdedding(pos_idx)
        x = tok_embd + pos_embd.unsqueeze(0)
        x = self.blocks(x)
...
class FeedForward(nn.Module):
    """a simple linear layer followed by non-linearitly"""
...
class Block(nn.Module):
    """Transformer (DECODEr BLOCK): calculations and computations"""
